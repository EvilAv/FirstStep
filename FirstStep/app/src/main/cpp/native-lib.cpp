...
char *personalization = "first-step-sample-app";
...
Java_com_example_firststep_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_com_example_firststep_MainActivity_randomBytes(JNIEnv *env, jclass, jint no) {
